...
CREATE INDEX idx_transaction_invoice ON public.transaction USING btree (invoice) WHERE (invoice IS NOT NULL);
...
CREATE INDEX idx_transaction_user_type_date ON public.transaction USING btree ("user", transaction_type, payment_date DESC);