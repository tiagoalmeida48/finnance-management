    ...
    >
      ...
      <TableCell className="w-12 px-1 py-2">
        {!t.card_id ? (
          ...
          <Text
            as="span"
            title={messages.transactions.row.paidViaBillTitle}
          ...
          <Container unstyled className={t.is_paid ? 'opacity-100' : 'opacity-70'}>
            <Container unstyled className="flex flex-wrap items-center gap-1.5">
              ...
              {t.installment_number && (
                <Text
                  as="span"
                  className={`${chipBase} bg-[var(--color-secondary)]/10 text-[var(--color-secondary)]`}
                >
              ...
              {!t.is_paid && (
                <Text
                  as="span"
                  className={`${chipBase} bg-[var(--color-warning)]/10 text-[var(--color-warning)]`}
                >
            ...
            {t.is_fixed && (
              <Container unstyled className="mt-1">
                <Text
                  as="span"
                  className={`${chipBase} bg-[var(--color-blue)]/10 text-[var(--color-blue)]`}
                >
          ...
          <Container unstyled className="min-h-6">
            {t.type !== 'transfer' ? (
              isBillPayment ? (
                <Text
                  as="span"
                  className={`${chipBase} bg-[var(--color-primary)]/10 text-[var(--color-primary)]`}
                >
            ...
            >
              ...
              {!t.payment_method &&
                (t.card_id
                  ...
                  : messages.transactions.row.paymentMethodAccount)}
            </Text>
            <Text
              ref={setCardNameRef}
