  ...
  return (
    ...
    >
      <Container unstyled className="space-y-3">
        <Container
          unstyled
          className="flex items-center gap-2 rounded-md border border-[var(--color-primary)33] bg-[var(--color-primary)0D] p-2"
        >
          <CardIcon size={24} color="var(--color-primary)" />
          <Container unstyled>
            <Text className="text-xs text-white/70">
              {payBillMessages.billLabel(statementMonth)}
            </Text>
            <Text className="text-lg font-extrabold text-[var(--color-primary)]">
              {totalAmountLabel}
            </Text>
          </Container>
        </Container>
