...
import {
    ...
    Dumbbell, Book, Music, Film, Gamepad2, Camera, Palette, Languages,
    Dog, GraduationCap, Pill, Stethoscope, Baby, Users, HeartPulse,
    Smartphone, Laptop, Tv, Ghost, Rocket, Wallet, DollarSign, PiggyBank,
    Store, Trash2, Brush
} from 'lucide-react';
        ...
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Stack spacing={3} sx={{ mt: 1 }}>
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                label="Tipo"
                                {...register('type')}
                                defaultValue={category?.type || defaultType}
                            >
                                ...
                                {iconOptions.map((opt) => (
                                    <Grid key={opt.value}>
                                        <IconButton
                                            ...
                                            sx={{
                                                border: '1px solid',
                                                borderColor: selectedIcon === opt.value ? 'primary.main' : 'rgba(255,255,255,0.1)',
                                                bgcolor: selectedIcon === opt.value ? 'rgba(212, 175, 55, 0.1)' : 'transparent',
                                                color: selectedIcon === opt.value ? 'primary.main' : 'text.secondary',
                                    ...
                                    <Grid key={color}>
                                        <Box
                                            ...
                                            sx={{
                                                ...
                                                boxShadow: selectedColor === color ? '0 0 0 2px rgba(212, 175, 55, 0.5)' : 'none',
                ...
                <DialogActions sx={{ p: 3, pt: 0 }}>
                    ...
                    <Button variant="contained" type="submit" disabled={createCategory.isPending || updateCategory.isPending}>
