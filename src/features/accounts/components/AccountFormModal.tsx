...
interface AccountFormModalProps {
    open: boolean;
    onClose: () => void;
    account?: Account; // If provided, it's an edit mode
}
                ...
                <DialogContent>
                    <Stack spacing={3} sx={{ mt: 1 }}>
                        ...
                        <Stack direction="row" spacing={2}>
                            ...
                            {account && (
                                <TextField
                                    ...
                                    helperText={errors.current_balance?.message || 'Ajuste manual do saldo'}
                                    inputProps={{ step: '0.01' }}
                                    InputProps={{
                                        startAdornment: <Box sx={{ mr: 1, color: 'text.secondary' }}>R$</Box>,
                                    }}
                        ...
                        <TextField
                            ...
                            rows={3}
                            {...register('notes')}
                            placeholder="Alguma observação sobre esta conta..."
                        />
...
const Box = ({ children, sx }: { children: React.ReactNode; sx?: any }) => (
    <span style={{ display: 'inline-flex', alignItems: 'center', ...sx }}>{children}</span>
);
