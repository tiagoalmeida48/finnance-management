...
import { usePayBill } from '../../transactions/hooks/useTransactions';
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <DialogContent>
                    <Stack spacing={3}>
                        ...
                        <TextField
                            ...
                            InputProps={{
                                startAdornment: <Landmark size={18} style={{ marginRight: 8, opacity: 0.5 }} />
                            }}
                        >
                                ...
                                <MenuItem key={account.id} value={account.id}>
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
                                        ...
                                        <Typography variant="caption" sx={{ opacity: 0.7 }}>
                                            Saldo: {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(account.current_balance)}
                                        </Typography>
                                    </Box>
                                </MenuItem>
                            ))}
                        ...
                        <Typography variant="caption" color="text.secondary" sx={{ fontStyle: 'italic' }}>
                            * Todas as transações selecionadas desta fatura serão marcadas como pagas e um registro de despesa será criado na conta bancária.
                        </Typography>
                    </Stack>
                </DialogContent>
                ...
                <DialogActions sx={{ p: 3 }}>
                    ...
                    <Button
                        ...
                        startIcon={payBill.isPending && <CircularProgress size={16} color="inherit" />}
                    >
