...
import {
  SiteBrandingContext,
  SiteBranding,
} from "./site-branding-context-object";
import {
  defaultSiteBranding,
  fetchSiteBranding,
  saveSiteBranding,
} from "@/shared/services/site-branding.service";
...
export function SiteBrandingProvider({
  ...
  const updateBranding = useCallback(
    async (updates: Partial<SiteBranding>) => {
      const nextTitle =
        updates.siteTitle !== undefined
          ? updates.siteTitle.trim()
          : branding.siteTitle;
      const nextLogoImage =
        updates.logoImage !== undefined
          ? updates.logoImage
          : branding.logoImage;
