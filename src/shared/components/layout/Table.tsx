...
export const TableHead = forwardRef<HTMLTableSectionElement, HTMLAttributes<HTMLTableSectionElement>>(function TableHead(
    { className, ...props },
    ref,
) {
...
export const TableHeaderCell = forwardRef<HTMLTableCellElement, ThHTMLAttributes<HTMLTableCellElement>>(function TableHeaderCell(
    { className, ...props },
    ref,
) {
    return (
        <th
            ref={ref}
            className={cn('border-b border-[var(--overlay-white-03)] px-2 py-1 text-left text-[11px]', className)}
            {...props}
        />
    );
});
...
export const TableCell = forwardRef<HTMLTableCellElement, TdHTMLAttributes<HTMLTableCellElement>>(function TableCell(
    ...
    return (
        <td
            ref={ref}
            className={cn('border-b border-[var(--overlay-white-03)] px-2 py-1.5 text-sm text-[var(--color-text-secondary)]', className)}
            {...props}
        />
    );
});
