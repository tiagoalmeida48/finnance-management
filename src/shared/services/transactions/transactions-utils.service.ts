...
import { stripInstallmentSuffix, toDateKeyIgnoringTime } from '@/shared/utils/transactionsGroup.utils';
...
export const hasChangedValue = (field: keyof Transaction, currentValue: unknown, nextValue: unknown) =>
...
export const syncBalance = async (transaction: Transaction, action: 'add' | 'remove') => {
