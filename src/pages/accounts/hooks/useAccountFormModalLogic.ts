...
import {
  useCreateAccount,
  useUpdateAccount,
} from "@/shared/hooks/api/useAccounts";
...
const accountSchema = z.object({
  ...
  type: z.enum(
    ["checking", "savings", "investment", "wallet", "other"] as const,
    {
...
const mapAccountToFormValues = (account?: Account): AccountFormValues => ({
  ...
  initial_balance:
    account?.initial_balance ?? DEFAULT_ACCOUNT_FORM_VALUES.initial_balance,
  current_balance:
    account?.current_balance ?? DEFAULT_ACCOUNT_FORM_VALUES.current_balance,
