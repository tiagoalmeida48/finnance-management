        ...
        <Section>
            <Container>
                <Container unstyled className="flex flex-col gap-3">
                    ...
                    {logic.message && (
                        <Container unstyled
                            className={`rounded border p-2 text-sm ${logic.message.type === 'error'
                    ...
                    {!logic.currentSetting && (
                        <Container unstyled className="rounded border border-yellow-500/30 bg-yellow-500/10 p-2 text-sm text-yellow-100">
                            {pageMessages.noCurrentSetting}
                        </Container>
                    )}

                    <Card className="rounded-[14px] p-3">
                        <Container unstyled className="mb-4 inline-flex w-full items-center justify-center rounded-[12px] border border-[var(--color-border)] bg-[var(--overlay-white-03)] p-1 shadow-sm sm:w-auto">
                            <Button
                                type="button"
                                onClick={() => logic.setActiveTab('simulator')}
                                className={`flex-1 rounded-[10px] px-6 py-2 text-sm transition-all duration-200 sm:flex-none ${logic.activeTab === 'simulator'
                            ...
                            <Button
                                ...
                                className={`flex-1 rounded-[10px] px-6 py-2 text-sm transition-all duration-200 sm:flex-none ${logic.activeTab === 'settings'
                                    ? 'bg-[var(--color-primary)] font-bold text-[var(--color-background)] shadow-md'
                                    : 'bg-transparent font-medium text-[var(--color-text-secondary)] hover:bg-[var(--overlay-white-05)] hover:text-[var(--color-text-primary)]'
                                    }`}
                            >
