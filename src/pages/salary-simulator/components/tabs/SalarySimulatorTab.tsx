...
export function SalarySimulatorTab(props: SalarySimulatorTabProps) {
  return (
    <>
      <SalarySimulatorPanel {...props} />
    </>
  );
}
  ...
  return (
    <Card className="rounded-[14px]">
      <CardContent className="p-4">
        <Text className="mb-3 font-bold text-[var(--color-text-primary)]">
          {tabMessages.summaryTitle}
        </Text>
        <Container unstyled className="flex flex-col">
          <SummaryRow
...
function SummaryRow({
  ...
  return (
    ...
    >
      <Text
        className={`text-sm ${bold ? 'font-semibold text-[var(--color-text-primary)]' : 'text-[var(--color-text-secondary)]'}`}
      >
        {label}
      </Text>
