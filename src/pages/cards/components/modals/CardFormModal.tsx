        ...
        <FormDialog
            ...
            actions={(
                <>
                    ...
                    >
                        {isSaving && (
                            <Text as="span" className="mr-1.5 inline-block h-4 w-4 animate-spin rounded-full border-2 border-[var(--color-background)] border-r-transparent" />
                        )}
            ...
            <Stack className="gap-2.5">
                ...
                <FormField label={formMessages.fields.creditLimit}>
                    <Container unstyled className="relative">
                        <Text as="span" className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-white/70">R$</Text>
                        <Input
                ...
                <FormField label={formMessages.fields.notes}>
                    <TextareaField rows={2} placeholder={formMessages.fields.notesPlaceholder} {...register('notes')} />
                </FormField>
    ...
    return (
        <Stack className="rounded-[10px] border border-[var(--color-border)] bg-[var(--overlay-primary-08)] p-1.5">
            ...
            <Row className="mb-1 flex-col gap-1 sm:flex-row">
                <Text as="span" className="inline-flex rounded-full bg-white/10 px-2 py-0.5 text-xs text-[var(--color-text-primary)]">
            ...
            <Text className="mt-0.75 text-[11px] text-[var(--color-text-muted)]">{cycleMessages.hint}</Text>
        </Stack>
    );
}
