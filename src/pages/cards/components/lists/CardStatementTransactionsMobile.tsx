...
function StatementMobileRow({
    ...
    return (
        <Container unstyled onClick={() => onEditTransaction?.(transaction)} className="cursor-pointer p-2 active:bg-white/5">
            <Row className="justify-between gap-2">
                ...
                <Text
                    as="span"
                    className={`whitespace-nowrap text-sm font-semibold ${transaction.type === 'income' ? 'text-[var(--color-success)]' : 'text-[var(--color-error)]'
                        }`}
                >
