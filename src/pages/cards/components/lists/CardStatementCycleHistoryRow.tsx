...
export function CardStatementCycleHistoryRow({
    ...
    return (
        <TableRow>
            ...
            <TableCell className="text-[13px]">{cycleHistoryMessages.dayLabel(cycle.closing_day)}</TableCell>
            ...
            <TableCell className="text-[13px]">
                {isCurrent ? (
                    ...
                    <Text as="span" className="inline-flex rounded bg-white/10 px-2 py-0.5 text-xs text-[var(--color-text-secondary)]">
