        ...
        <>
            ...
            <Stack className="gap-2">
                <CollectionState
                    ...
                    isEmpty={isEmpty}
                    emptyFallback={(
                        <Container unstyled className="rounded-xl border border-[var(--color-border)] bg-[var(--color-card)] p-4 text-center">
                            <Text className="text-[var(--color-text-secondary)]">{statementMessages.noStatements}</Text>
                        </Container>
                    )}
                >
