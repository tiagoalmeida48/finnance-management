...
const cycleSchema = z.object({
    ...
    closing_day: z.number().min(1, cycleHistoryMessages.errors.invalidDay).max(31, cycleHistoryMessages.errors.invalidDay),
    due_day: z.number().min(1, cycleHistoryMessages.errors.invalidDay).max(31, cycleHistoryMessages.errors.invalidDay),
...
export function useCardStatementCycleHistoryLogic({
    ...
    const handleOpenEdit = useCallback((cycle: CreditCardStatementCycle) => {
        setFormError(null);
    ...
    const submitForm = handleSubmit(async (values) => {
        ...
        try {
            ...
            const message = error instanceof Error ? error.message : cycleHistoryMessages.errors.saveFailed;
    ...
    const handleDelete = useCallback(async () => {
        ...
        try {
            ...
            const message = error instanceof Error ? error.message : cycleHistoryMessages.errors.deleteFailed;
            setFormError(message);
        }
