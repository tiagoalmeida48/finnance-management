                ...
                <Container unstyled key={iidx}>
                    <Container unstyled className="flex items-center justify-between gap-1.5">
                        <Container unstyled className="flex min-w-0 flex-1 items-center gap-1">
                            <Container unstyled className="grid h-[18px] w-[18px] shrink-0 place-items-center rounded-[6px] border border-[var(--color-border)] bg-[var(--color-surface)]">
                                {item.itemType === 'card' ? (
                            ...
                            <Text
                                className={`truncate text-sm font-medium ${item.isPaid
