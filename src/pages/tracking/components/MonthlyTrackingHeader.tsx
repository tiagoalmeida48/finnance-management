    ...
    return (
        <Container unstyled className="mb-1.5 flex items-center justify-between">
            <Container unstyled className="flex min-w-0 items-center gap-1.5">
                ...
                <Text
                    className={`text-sm font-bold ${isSettled ? 'text-[var(--color-success)]' : 'text-[var(--color-primary)]'
                        }`}
                >
            ...
            <Text
                as="span"
                className={`inline-flex h-[22px] items-center rounded-full border px-2 text-[11px] font-bold ${isSettled
