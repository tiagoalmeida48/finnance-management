  ...
  return (
    ...
    >
      ...
      >
        <Container
          unstyled
          className="flex shrink-0 gap-1 rounded-xl bg-black/40 p-1"
        >
          <TabButton
          ...
          <TabButton
            ...
            onClick={() =>
              setTypeFilter(typeFilter === "expense" ? null : "expense")
            }
          >
          ...
          <TabButton
            ...
            onClick={() =>
              setTypeFilter(typeFilter === "transfer" ? null : "transfer")
            }
          >
      ...
      >
        ...
        <Container unstyled className="flex shrink-0 gap-2">
          ...
          {!showAllTime && !showInstallmentsOnly && (
            <Container
              unstyled
              className="flex items-center gap-1 rounded-xl bg-black/40 p-1"
            >
              <IconButton
                size="small"
