    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
      <DialogTitle className="pt-6">
        <Container unstyled className="flex items-center gap-2 font-bold">
          <Container
            unstyled
            className="rounded-md bg-[var(--overlay-error-10)] p-2 text-[var(--color-error)]"
          >
      ...
      <DialogContent className="pb-2">
        <Container unstyled className="mt-1 flex flex-col gap-4">
          ...
          <Container
            unstyled
            className="rounded-lg border border-[var(--overlay-white-05)] bg-[var(--overlay-white-03)] p-2"
          >
...
>>>>>>> finnance-management/main
          ...
          {!isPartOfGroup && (
            <Text className="text-sm text-[var(--color-text-secondary)]">
              {deleteModalMessages.irreversibleAction}
            </Text>
          )}
        </Container>
      </DialogContent>
