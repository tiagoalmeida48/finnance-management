    ...
    return (
        <Container unstyled className="space-y-2">
            <label
                ...
                className={`group flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed py-8 text-center transition-all ${isDragOver
            ...
            >
                ...
                <Upload className="mb-4 opacity-50 transition-all group-hover:text-[var(--color-primary)] group-hover:opacity-100" size={48} />
                <h3 className="text-lg font-semibold">{uploadMessages.selectCsvTitle}</h3>
                <Text className="text-sm text-[var(--color-text-secondary)]">{uploadMessages.dragAndDropHint}</Text>
            </label>
