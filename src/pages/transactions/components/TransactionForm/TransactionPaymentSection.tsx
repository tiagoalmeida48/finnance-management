...
export function TransactionPaymentSection({
    ...
    const labelClass = 'mb-1 block text-[11px] font-medium uppercase tracking-wider text-[var(--color-text-secondary)]';
    ...
    const paymentMethodOptions = [
        { value: 'money', label: messages.transactions.form.payment.methodMoney, icon: <Banknote size={16} /> },
        { value: 'debit', label: messages.transactions.form.payment.methodDebit, icon: <CreditCardIcon size={16} /> },
        { value: 'credit', label: messages.transactions.form.payment.methodCredit, icon: <CreditCardIcon size={16} /> },
        { value: 'pix', label: messages.transactions.form.payment.methodPix, icon: <ArrowRightLeft size={16} /> },
        { value: 'bill_payment', label: messages.transactions.form.payment.methodBillPayment, icon: <ScanBarcode size={16} /> },
    ];
        ...
        <Container unstyled className="mb-2">
            ...
            <Container unstyled className={`mb-2 flex gap-2 ${isMobile ? 'flex-col' : 'flex-row'}`}>
                <Container unstyled className="flex-[1.5]">
                    <label className={labelClass}>{messages.transactions.form.payment.paymentMethodLabel}</label>
                    <Controller
                        name="payment_method"
                        control={control}
                        defaultValue="debit"
