...
export const getTypeConfig = (type: TransactionType) => {
  switch (type) {
    case "expense":
      return {
        color: colors.red,
        bgColor: "var(--overlay-error-15)",
        label: messages.transactions.form.type.expense,
      };
    case "income":
      return {
        color: colors.green,
        bgColor: "var(--overlay-success-15)",
        label: messages.transactions.form.type.income,
      };
    default:
      return {
        color: colors.blue,
        bgColor: "var(--overlay-info-15)",
        label: messages.transactions.form.type.transfer,
      };
  }
};
...
export const toggleConfig = {
  recurring: {
    ...
    label: messages.transactions.form.toggles.recurring,
  },
  installment: {
    icon: Layers,
    activeColor: colors.purple,
    label: messages.transactions.form.toggles.installment,
  },
};
