...
function SortButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      onClick={onClick}
      className={`inline-flex h-8 items-center gap-1.5 px-2 text-[10px] font-bold uppercase tracking-wider transition-colors hover:bg-white/5 ${
    ...
    >
      ...
      <Text
        as="span"
        className={`text-[10px] transition-opacity ${active ? "opacity-100" : "opacity-0"}`}
      >
        {direction === "asc" ? "↑" : "↓"}
      </Text>
    </Button>
