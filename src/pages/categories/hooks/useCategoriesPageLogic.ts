...
import { useCategories, useCreateCategory, useDeleteCategory } from '@/shared/hooks/api/useCategories';
...
export function useCategoriesPageLogic() {
    ...
    const handleAddDefault = async () => {
        const defaults: Array<Parameters<typeof createCategory.mutateAsync>[0]> = [...DEFAULT_CATEGORY_SEED];
