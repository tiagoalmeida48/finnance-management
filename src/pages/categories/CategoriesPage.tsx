    ...
    return (
        <Section>
            <Container>
                <PageHeader
                    title={(
                        <Row className="items-center gap-1">
                            <Heading level={1} className="text-2xl font-bold md:text-[34px] text-[var(--color-text-primary)] mb-0">{pageMessages.title}</Heading>
                ...
                <Container unstyled className="mb-3 flex flex-col justify-between gap-2 lg:flex-row lg:items-center">
